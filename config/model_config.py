...
MODEL_CONFIG = {
    "Pb": {
        "model_path": os.path.join("Fin_model", "best_xgb_Fin_Pb.pkl"),  # 跨平台路径
        "feature_path": os.path.join("Features_list", "feature_names_Fin_Pb.txt"),
        "train_data_path": os.path.join("example_data", "X_train_Pb.csv"),
        "target_name": "Ratio of Activation of Soil Pb",
        "model_type": "XGBoost"
    },
    "Cd": {
        "model_path": os.path.join("Fin_model", "best_xgb_Fin_Cd.pkl"),
        "feature_path": os.path.join("Features_list", "feature_names_Fin_Cd.txt"),
        "train_data_path": os.path.join("example_data", "X_train_Cd.csv"),
        "target_name": "Ratio of Activation of Soil Cd",
        "model_type": "XGBoost"
    },
    "As": {
        "model_path": os.path.join("Fin_model", "best_cb_Fin_As.pkl"),
        "feature_path": os.path.join("Features_list", "feature_names_Fin_As.txt"),
        "train_data_path": os.path.join("example_data", "X_train_As.csv"),
        "target_name": "Ratio of Activation of Soil As",
        "model_type": "CatBoost"
    }
}